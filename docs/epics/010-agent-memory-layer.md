...
| `docs/specs/agent-session.md` | **UPDATE** — successor spec for canonical agent-session ownership |
...
- [x] `docs/specs/agent-session.md` now serves as the successor spec for canonical agent-owned session persistence
...
| `docs/specs/agent-session.md` | ✅ Successor spec for canonical session persistence, schema, and architecture |
...
5. **Update documentation** — `docs/specs/agent-session.md` and `docs/specs/infrastructure.md` must reflect the simplified schema, updated partition key, and new document examples.
...
- [x] `docs/specs/agent-session.md` — successor spec updated with new document schema example (no `conversationId`), session field explanation, updated container diagram, and field ownership table
...
| `docs/specs/agent-session.md` | ✅ Updated schema, field ownership, diagrams, and code examples — all `conversationId` and `__users__` references removed |
...
**Documentation Scope** (`docs/specs/agent-session.md`):
...
- [x] `docs/specs/agent-session.md` and `docs/specs/infrastructure.md` updated
