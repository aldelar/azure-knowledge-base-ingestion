...
- **Memory**: Cosmos DB for canonical agent sessions and conversation ownership boundaries (see `docs/specs/agent-session.md` and `docs/specs/conversation-state-model.md`)
