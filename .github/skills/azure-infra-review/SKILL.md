...
### RBAC & Security
- [ ] All role assignments defined in `main.bicep` — not in individual modules
...
### Module Wiring
- [ ] New modules called from `main.bicep`
...
### Service Definitions
- [ ] `azure.yaml` lists all 6 services with correct paths and hosts:
